...
PYBIND11_MODULE(math_module, module) {
        ...
        py::class_<anvil::math::Vector2>(module, "Vector2")
            ...
            .def_property(
                "x", [](anvil::math::Vector2& v) { return py::module_::import("numpy").attr("float32")(v.x); },
                [](anvil::math::Vector2& v, anvil::f32 val) { v.x = val; })
            .def_property(
                "y", [](anvil::math::Vector2& v) { return py::module_::import("numpy").attr("float32")(v.y); },
            ...
            .def("__mul__",
                 [](const anvil::math::Vector2& a, const anvil::math::Vector2& b) {
                         return py::module_::import("numpy").attr("float32")(a * b);
                 })
        ...
        py::class_<anvil::math::Vector3>(module, "Vector3")
            ...
            .def_property(
                "x", [](anvil::math::Vector3& v) { return py::module_::import("numpy").attr("float32")(v.x); },
                [](anvil::math::Vector3& v, anvil::f32 val) { v.x = val; })
            .def_property(
                "y", [](anvil::math::Vector3& v) { return py::module_::import("numpy").attr("float32")(v.y); },
                [](anvil::math::Vector3& v, anvil::f32 val) { v.y = val; })
            .def_property(
                "z", [](anvil::math::Vector3& v) { return py::module_::import("numpy").attr("float32")(v.z); },
