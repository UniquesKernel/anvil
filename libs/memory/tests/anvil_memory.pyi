...
def scratch_allocator_copy(allocator: object, data: bytes, size: int) -> Optional[object]: ...
def scratch_allocator_move(allocator: int, data: int, size: int, free_func_ptr: int) -> Optional[object]: ... 
...
def stack_allocator_copy(allocator: object, data: bytes) -> Optional[object]: ...
