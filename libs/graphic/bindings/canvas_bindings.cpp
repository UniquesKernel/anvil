...
PYBIND11_MODULE(graphic_module, module) {
        ...
        py::class_<anvil::graphic::Canvas>(module, "Canvas")
            .def(py::init([](const anvil::u64 width, const anvil::u64 height, const char fill_char) {
            ...
            .def_property(
                ...
                [](anvil::graphic::Canvas& canvas, anvil::u64 val) { canvas.height = val; })
            .def_property(
                "width", [](const anvil::graphic::Canvas& canvas) { return canvas.width; },
                [](anvil::graphic::Canvas& canvas, anvil::u64 val) { canvas.width = val; })
            .def_property(
